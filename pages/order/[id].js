...
const Order = ({ params }) => {
  ...
  }, [userInfo, orderId, order, successPay, paypalDispatch, router]);

  const createOrder = (data, actions) => {
    //orderID is not from our website, it is the orderID generated by PayPal
  ...
  const onApprove = (data, actions) => {
    //this function is used after a successful payment in PayPal
